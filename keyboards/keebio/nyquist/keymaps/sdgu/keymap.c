...
[_QWERTY] = KEYMAP( \
  ...
  ADJUST,  KC_LCTL, KC_LGUI, KC_LALT, LOWER,   KC_SPC,  KC_BSPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
),
...
[_ADJUST] =  KEYMAP( \
  ...
  _______,   DVORAK,    DVORAK_OH, FUSION, QWERTY, _______, _______, _______, _______, _______, _______, _______, \
